...
AS
	...
	SELECT DISTINCT Registration_Category_ID, Tournament_Category_Name FROM #tmpEntry
	INNER JOIN vRegistrationCategory ON Registration_Category_ID = Tournament_Registration_Category_ID
